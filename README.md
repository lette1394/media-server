...
### 스페이스란?
파일들의 집합 및 이에 대한 연산이다. 스페이스는 여러 파일로 구성되며, 파일의 크기나 종류에 상관없이 스페이스는 논리적인 단위로 파일을 다룬다. 다른 스페이스에 있는 파일 역시 연산의 일부로서 간주할 수 있다. 유저가 
